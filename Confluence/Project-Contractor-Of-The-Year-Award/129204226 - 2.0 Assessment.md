...
**Objective:** Apply the evaluation framework, score independently, and produce a per-category shortlist. Categories were assigned at intake (DR-003); Stage 1 does not invent them.
...
**Objective:** Final evaluation of shortlisted nominees through presentations and Q&A. Name **three places per category** and **one overall** Project Contractor of the Year. Stage 2 does **not** assign categories.
...
flowchart TD
    ...
    L -->|Yes| P[Places and overall named]
```

Finalists present and answer Q&A; judges rescore with emphasis on exemplariness and Innovation & Industry Advancement. Panel names three places per category plus one overall winner (DR-003).
