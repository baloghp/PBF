...
```mermaid
flowchart TD
    A[Panel Review] --> B[Verify four awards]
    B --> C[Confirm Overall and category awards]
...
1. **Panel/consolidated review**
    ...
    * Verify **four awards**: Overall, Small, Medium, Large
    * Confirm dual titles where both apply
...
2. **Prepare publication materials**
    ...
    * Write short case stories for the **four award winners**:
    
        * Overall Project Contractor of the Year
        * Small, Medium, and Large category awards
