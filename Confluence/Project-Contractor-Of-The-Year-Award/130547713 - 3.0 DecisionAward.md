...
- Confluence version: `2026-06-29T21:17:41.637Z`
...
```mermaid
flowchart TD
    A[Panel Review] --> B[Verify three places per category]
    B --> C[Confirm overall winner]
    C --> D[Prepare Winner Notifications]
    D --> E[Prepare Non-Winner Notifications]
    E --> F[Final Approval by Programme Owner]
    F --> G{Appeals Received?}
    G -->|Yes| H[Process Appeals]
    H --> I[Respond to Appeals]
    I --> J[Send All Notifications]
    G -->|No| J
...
1. **Panel/consolidated review**
    ...
    * Verify three places per category (Small, Medium, Large)
    * Confirm the overall Project Contractor of the Year (from the Stage 2 field; normally also a category first place)
...
5. **Final approval**
    ...
    * **Programme Owner** reviews and approves final winner decisions (governance sign-off)
    * **Project Manager** verifies documentation complete and process integrity
    * Confirm publication consents obtained
    * Approve for announcement
    
6. **Send notifications** (**Communications Coordinator**)
...
* **Responsible:** Communications Coordinator (prepare templates + send notifications)
* **Accountable:** Project Manager
* **Consulted:** Programme Owner (final winner sign-off), Judging Panel, Assessors (feedback content)
* **Informed:** Applicants
...
2. **Prepare publication materials**
    ...
    * Write short case stories for:
        ...
        * Overall Project Contractor of the Year
        * Category first places
        * Remaining category places (second and third) as capacity allows
...
* **Accountable:** Project Manager
* **Consulted:** Programme Owner, Judging Panel
