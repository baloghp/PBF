...
* **Multiple nominations:** one nominator may submit more than one nomination from the same account. Each nomination is a **distinct project**, with its own packet and client evaluation. The same contracted engagement cannot be entered twice. See [DR-003](https://ittd.atlassian.net/wiki/spaces/PBF/pages/301105153).
...
* **Project Manager / Award Operations** assigns category (Small / Medium / Large) from customer-project headcount.
