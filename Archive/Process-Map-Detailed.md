# PBF Contractor of the Year - Detailed Process Map

**Status:** Draft for Review  
**Last Updated:** 2025-11-26  
**Related Confluence Page:** https://ittd.atlassian.net/wiki/spaces/PBF/pages/117866524/Process+Map
...
3. **Eligibility screening**
   - Verify eligibility criteria:
     ...
     - Project category classification (Start-up, Established, Mature)
...
6. **Shortlisting**
   ...
   - Rank nominations within each category:
     - Start-ups (0-5 years)
     - Established organizations (6-15 years)
...
1. **Finalist preparation**
   - Shortlisted nominees receive:
     ...
     - Instructions to include:
       ...
       - At least two artifacts (interface RACI snapshot, payment curve)
...
```
Submission → Intake → Stage 1 Assessment → Shortlisting → Stage 2 Assessment → Decision → Award Publication
    ↓            ↓              ↓                ↓                ↓              ↓            ↓
  Nominee    Validation    Volunteer      Notification    Judging Panel   Winner      Public
  Submits    & Eligibility  Screening      (All Applicants) Presentation   Selection   Recognition
```
...
- Publication locations need to be confirmed
- Ceremony format (virtual vs in-person) needs decision
- Data retention and deletion policies need to be applied post-award

---

*This process map should be reviewed and approved before implementation. All stakeholders should review and provide feedback.*
